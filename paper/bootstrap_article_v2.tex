...
versions and the outputs in the README; (iv) [done: public repository, release \texttt{v1.0-submission}, Zenodo DOI below]
keep the repository, its releases and the Zenodo record in step, and cite the DOI here and
in a data-availability statement, not in the abstract; (v) only then state that the calculations can be
...
The notebooks, data file, README and the source of this paper are available in the
repository \url{https://github.com/fernandotcbrandt/goldberg-palatini-bootstrap}, release
\texttt{v1.0-submission}, archived at \url{https://doi.org/10.5281/zenodo.22757770} (this
version; \url{https://doi.org/10.5281/zenodo.22757769} resolves to the latest version).
